...
import { CreateUsersBanListRecordDto } from './create-users-ban-list-record.dto';

export class CreateUsersBanListRecordRequestBodyDto
  implements Omit<CreateUsersBanListRecordDto, 'userId'>
{
  @ApiProperty({
