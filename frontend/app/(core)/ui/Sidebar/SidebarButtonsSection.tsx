...
const SidebarButtonsSection: FC<SidebarButtonsSectionProps> = ({ ...props }) => {
  return (
    <div {...props}>
      <button
        onClick={() => signOut()}
        className='inline-flex p-3 md:px-5 md:py-3 font-medium hover:bg-slate-100 transition-[0.3s_ease] rounded-xl text-gray-500'
      >
        <SignOutIcon className='size-6 stroke-2 md:me-3' />
